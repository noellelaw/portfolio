...
with st.container():
    ...
    with col1:
        ...
        st.markdown(f"<p style=color:#4D4545;'>Python</p>", 
                unsafe_allow_html=True)
    with col2:
        st_lottie(ml_lottie,height=200,width=200, key="ml", speed=1)
        st.write(f"<p style=color:#4D4545;'>AI / ML / CV</p>", 
                unsafe_allow_html=True)
        st_lottie(datascience_lottie, height=200,width=200, key="ds", speed=1)
        st.markdown(f"<p style=color:#4D4545;'>Data Science</p>", 
                unsafe_allow_html=True)
    with col3:
        st_lottie(sim_lottie,height=200,width=200, key="simulation", speed=1)
        st.write(f"<p style=color:#4D4545;'>Modelling & Sim</p>", 
                unsafe_allow_html=True)
        st_lottie(ros_lottie, height=200,width=150, key="ros", speed=1)
        st.markdown(f"<p style=color:#4D4545;'>Robotics & ROS</p>", 
                unsafe_allow_html=True)
    
    with col4:
        st_lottie(embedded_lottie,height=200,width=200, key="embedded", speed=1)
